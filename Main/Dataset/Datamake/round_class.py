...
output_dir = "C:/Users/cecil/OneDrive/Documents/Dataset_CloudOrgs/VL0/round_class/output/"
os.makedirs(output_dir, exist_ok=True)

# Extensões de arquivo permitidas
allowed_extensions = ['.png', '.jpg', '.jpeg', '.tiff']

# Definir tamanho mínimo para salvar as figuras
min_size = 50
...
for image_file in os.listdir(input_dir):
    if any(image_file.endswith(ext) for ext in allowed_extensions):
        ...
        for k, region in enumerate(regions):
            ...
            if height * width < min_size:  # Não salva figuras pequenas
                continue
