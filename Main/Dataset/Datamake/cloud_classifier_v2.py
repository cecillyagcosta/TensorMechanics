...
# Função para verificar se o tamanho é próximo de 11x12
...
output_dir = "C:/Users/cecil/OneDrive/Documents/Dataset_CloudOrgs/VL0/round_class/cloud_classifier/run_3"
...
for image_file in os.listdir(input_dir):
    if any(image_file.endswith(ext) for ext in allowed_extensions):
        ...
        if len(regions) == 0:
            print("Nenhuma região encontrada, verifique a imagem e o limiar.")
            continue
        ...
        for k, region in enumerate(regions):
            ...
            figure_name = f'figura_{k}_size_{height}x{width}_{intensity_class}_from_{image_file.split(".")[0]}'
